                            ...
                            <SwiperSlide>
                                <div className="trending-item block relative cursor-pointer" onClick={() => handleTypeClick('utensil')}>
                                    ...
                                    <div className="trending-name text-center mt-5 duration-500">
                                        <span className='heading6'>Food & Beverages</span>
                                    </div>
                                </div>
                            </SwiperSlide>
                            <SwiperSlide>
                                <div className="trending-item block relative cursor-pointer" onClick={() => handleTypeClick('sweater')}>
                                    ...
                                    <div className="trending-name text-center mt-5 duration-500">
                                        <span className='heading6'>Restaurant Supplies</span>
                                    </div>
                                </div>
                            </SwiperSlide>
                            <SwiperSlide>
                                <div className="trending-item block relative cursor-pointer" onClick={() => handleTypeClick('top')}>
                                    ...
                                    <div className="trending-name text-center mt-5 duration-500">
                                        <span className='heading6'>Appliance & Tool</span>
                                    </div>
                                </div>
                            </SwiperSlide>
                            <SwiperSlide>
                                <div className="trending-item block relative cursor-pointer" onClick={() => handleTypeClick('dress')}>
                                    ...
                                    <div className="trending-name text-center mt-5 duration-500">
                                        <span className='heading6'>General Supplies</span>
                                    </div>
                                </div>
                            </SwiperSlide>
                            <SwiperSlide>
                                <div className="trending-item block relative cursor-pointer" onClick={() => handleTypeClick('swimwear')}>
                                    ...
                                    <div className="trending-name text-center mt-5 duration-500">
                                        <span className='heading6'>Boba</span>
                                    </div>
                                </div>
                            </SwiperSlide>
                            <SwiperSlide>
                                <div className="trending-item block relative cursor-pointer" onClick={() => handleTypeClick('outerwear')}>
                                    ...
                                    <div className="trending-name text-center mt-5 duration-500">
                                        <span className='heading6'>Popping Pearls</span>
                                    </div>
                                </div>
                            </SwiperSlide>
                            <SwiperSlide>
                                <div className="trending-item block relative cursor-pointer" onClick={() => handleTypeClick('shirt')}>
                                    ...
                                    <div className="trending-name text-center mt-5 duration-500">
                                        <span className='heading6'>Jellies</span>
                                    </div>
                                </div>
                            </SwiperSlide>
                            <SwiperSlide>
                                <div className="trending-item block relative cursor-pointer" onClick={() => handleTypeClick('shirt')}>
                                    ...
                                    <div className="trending-name text-center mt-5 duration-500">
                                        <span className='heading6'>Syrups</span>
                                    </div>
                                </div>
                            </SwiperSlide>
                            <SwiperSlide>
                                <div className="trending-item block relative cursor-pointer" onClick={() => handleTypeClick('shirt')}>
                                    ...
                                    <div className="trending-name text-center mt-5 duration-500">
                                        <span className='heading6'>Tea Leaves</span>
                                    </div>
                                </div>
                            </SwiperSlide>
                            <SwiperSlide>
                                <div className="trending-item block relative cursor-pointer" onClick={() => handleTypeClick('shirt')}>
                                    ...
                                    <div className="trending-name text-center mt-5 duration-500">
                                        <span className='heading6'>Bowls</span>
                                    </div>
                                </div>
                            </SwiperSlide>
                            <SwiperSlide>
                                <div className="trending-item block relative cursor-pointer" onClick={() => handleTypeClick('shirt')}>
                                    ...
                                    <div className="trending-name text-center mt-5 duration-500">
                                        <span className='heading6'>Plates</span>
                                    </div>
                                </div>
                            </SwiperSlide>
                            <SwiperSlide>
                                <div className="trending-item block relative cursor-pointer" onClick={() => handleTypeClick('shirt')}>
                                    ...
                                    <div className="trending-name text-center mt-5 duration-500">
                                        <span className='heading6'>Cups & Lids</span>
                                    </div>
                                </div>
                            </SwiperSlide>
                            <SwiperSlide>
                                <div className="trending-item block relative cursor-pointer" onClick={() => handleTypeClick('shirt')}>
                                    ...
                                    <div className="trending-name text-center mt-5 duration-500">
                                        <span className='heading6'>Fold-To-Go</span>
                                    </div>
                                </div>
                            </SwiperSlide>
                            <SwiperSlide>
                                <div className="trending-item block relative cursor-pointer" onClick={() => handleTypeClick('shirt')}>
                                    ...
                                    <div className="trending-name text-center mt-5 duration-500">
                                        <span className='heading6'>Straws</span>
                                    </div>
                                </div>
                            </SwiperSlide>
                            <SwiperSlide>
                                <div className="trending-item block relative cursor-pointer" onClick={() => handleTypeClick('shirt')}>
                                    ...
                                    <div className="trending-name text-center mt-5 duration-500">
                                        <span className='heading6'>Utensils</span>
                                    </div>
                                </div>
                            </SwiperSlide>
                            <SwiperSlide>
                                <div className="trending-item block relative cursor-pointer" onClick={() => handleTypeClick('shirt')}>
                                    ...
                                    <div className="trending-name text-center mt-5 duration-500">
                                        <span className='heading6'>Warehouse Supplies</span>
                                    </div>
                                </div>
                            </SwiperSlide>
                            <SwiperSlide>
                                <div className="trending-item block relative cursor-pointer" onClick={() => handleTypeClick('shirt')}>
                                    ...
                                    <div className="trending-name text-center mt-5 duration-500">
                                        <span className='heading6'>Gloves</span>
                                    </div>
                                </div>
                            </SwiperSlide>
                            <SwiperSlide>
                                <div className="trending-item block relative cursor-pointer" onClick={() => handleTypeClick('shirt')}>
                                    ...
                                    <div className="trending-name text-center mt-5 duration-500">
                                        <span className='heading6'>Deli/Soup Containers</span>
                                    </div>
                                </div>
                            </SwiperSlide>
                            <SwiperSlide>
                                <div className="trending-item block relative cursor-pointer" onClick={() => handleTypeClick('shirt')}>
                                    ...
                                    <div className="trending-name text-center mt-5 duration-500">
                                        <span className='heading6'>Salad Containers</span>
                                    </div>
                                </div>
                            </SwiperSlide>
                            <SwiperSlide>
                                <div className="trending-item block relative cursor-pointer" onClick={() => handleTypeClick('shirt')}>
                                    ...
                                    <div className="trending-name text-center mt-5 duration-500">
                                        <span className='heading6'>Microwaveable Containers</span>
                                    </div>
                                </div>
                            </SwiperSlide>
                        </Swiper>
