...
const ShopBreadCrumb1_old: React.FC<Props> = ({ data, productPerPage, dataType, gender, category }) => {
    ...
    let filteredData = data.filter(product => {
        ...
        return isShowOnlySaleMatched && isDataCategoryMatched && isBrandMatched
                        ...
                        <div className="sidebar lg:w-1/4 md:w-1/3 w-full md:pr-12">
                                    ...
                                    {['Food & Beverages','Restaurant Supplies', 'Appliance & Tool', 'General Supplies', 'Boba', 'Popping Pearls', 'Jellies', 'Syrups', 'Tea Leaves', 'Bowls', 'Plates', 'Cups & Lids', 'Fold-To-Go', 'Straws', 'Utensils', 'Warehouse Supplies', 'Gloves', 'Deli/Soup Containers', 'Salad Containers', 'Microwaveable Containers'].map((item, index) => (
                                        ...
                                        >
                                            ...
                                            <div className='text-secondary2'>
                                                ({data.filter(dataItem => dataItem.category === 'Food & Beverages').length})
                                            </div>
                                        </div>
                                    ))}
                                </div>
                            ...
                            <div className="filter-brand mt-8">
                                ...
                                <div className="list-brand mt-4">
                                    {['Karat Packaging', 'Karat Earth', 'Teazone'].map((item, index) => (
