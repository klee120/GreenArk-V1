...
const Default: React.FC<Props> = ({ data, productId }) => {
            ...
            <div className="product-detail default">
                <div className="featured-product underwear md:py-20 py-10">
                    <div className="container flex justify-between gap-y-6 flex-wrap">
                        <div className="list-img md:w-2/5 md:pr-[45px] w-full">
                            <Swiper
                                slidesPerView={1}
                                spaceBetween={0}
                            ...
                            <Swiper
                                ...
                                className="mySwiper"
                            >
                                {/* {productMain.images.slice(0, 5).map((item, index) => (
    <SwiperSlide key={index}>
        ...
        />
                        ...
                        <div className="product-infor md:w-3/5 w-full lg:pl-[15px] md:pl-2">
                            ...
                            {/* <div className='desc text-secondary mt-3'>{productMain.id}</div> */}
                            {productMain.description !== "" ? (<div className="flex items-center gap-3 flex-wrap mt-5 pb-6 border-b border-line">
                                <div className='desc text-secondary mt-3'>{productMain.description}</div>
                            </div>) : <div className="flex items-center pb-6 border-b border-line"/>}
                    ...
                    <tbody>
                        {productMain.variation.map((item, index) => (
                            <tr key={index} className="border border-gray-300">
            ...
            </div>                                {/* <div className="choose-size mt-5">
                                ...
                                {productMain.brand !== "" && (<div className="more-infor mt-6">
